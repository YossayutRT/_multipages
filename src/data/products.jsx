...
export function fetchProducts() {
    ...
    if(productsWithPrices.length === 0) {
        ...
        productsWithPrices = products.map((product) => {
            // clone the product object and remove unwanted properties
            const updatedProduct = { ...product };
            delete updatedProduct.albumId;
            delete updatedProduct.url;
            // add a random price
            updatedProduct.price = Math.round(Math.random() * 10000) / 100;
            return updatedProduct;
        });
    }
    // return first 5 products from cache
    return productsWithPrices.slice(0, 70);
}
